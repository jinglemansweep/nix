...
## Poetry Project Management (Alternative)

> **Note:** For new projects, prefer standard `pyproject.toml` with hatchling (shown above). Use Poetry only when an existing project already uses it.
